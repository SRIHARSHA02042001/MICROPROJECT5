...
<body>
	<div class="container">
		...
		<input class="form-control form-control-sm" type="text" name="vital" id="vital" style="display:inline-block; width:300px;margin-top:25px;""><br>
		...
		<input class="form-control form-control-sm" type="text" name="address" id="address" style="display:inline-block; width:300px;margin-top:25px;""><br>
	...
	<script>
		var websocket=new WebSocket("ws://localhost:8085/WebSocket2/VitalCheckEndPoint");
		...
		{
			if(vital.value<90){
				console.log(vital.value+','+phn.value+','+address.value);
				websocket.send(vital.value+','+phn.value+','+address.value);
			}
			else{
				window.alert("Your oxygen level is normal.So no need to consult a doctor");
			}
			vital.value="";
		}
	</script>
