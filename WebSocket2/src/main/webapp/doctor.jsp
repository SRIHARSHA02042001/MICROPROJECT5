			...
			if(jsonData.message!=null)
				{
					...
					row.innerHTML="<td>"+details[0]+"</td><td>"+details[1]+"</td><td><button class=\"btn btn-danger btn-sm\" onclick=\"sendInstructions('"+details[0]+"','ambulance','"+details[2]+"','"+details[3]+"')\">Summon Ambulance</button><button type=\"button\" class=\"btn btn-primary btn-sm\" onclick=\"sendInstructions('"+details[0]+"','medication','','')\">Suggest Medication</button></td>";
				}
		}
		function sendInstructions(username,message,phn,add)
		{
			...
			{
				console.log(username+','+message+','+phn+','+add);
				websocket.send(username+','+message+','+phn+','+add);	
			}
		}
	</script>
</body>
